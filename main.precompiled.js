...
function dart_precompiled($collectedClasses) {
  ...
  playLoop_closure.builtin$cls = "playLoop_closure";
  if (!"name" in playLoop_closure)
    playLoop_closure.name = "playLoop_closure";
  $desc = $collectedClasses.playLoop_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  playLoop_closure.prototype = $desc;
  ...
  function drawUI_closure() {
  }
  drawUI_closure.builtin$cls = "drawUI_closure";
  if (!"name" in drawUI_closure)
    drawUI_closure.name = "drawUI_closure";
  $desc = $collectedClasses.drawUI_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ...
  function EventTarget_on_closure() {
  }
  EventTarget_on_closure.builtin$cls = "EventTarget_on_closure";
  if (!"name" in EventTarget_on_closure)
    EventTarget_on_closure.name = "EventTarget_on_closure";
  $desc = $collectedClasses.EventTarget_on_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  EventTarget_on_closure.prototype = $desc;
  function EventTarget_one_closure() {
  }
  EventTarget_one_closure.builtin$cls = "EventTarget_one_closure";
  if (!"name" in EventTarget_one_closure)
    EventTarget_one_closure.name = "EventTarget_one_closure";
  $desc = $collectedClasses.EventTarget_one_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  EventTarget_one_closure.prototype = $desc;
  function loadImage_closure(comp_0, img_1) {
    this.comp_0 = comp_0;
    this.img_1 = img_1;
  }
  loadImage_closure.builtin$cls = "loadImage_closure";
  if (!"name" in loadImage_closure)
    loadImage_closure.name = "loadImage_closure";
  $desc = $collectedClasses.loadImage_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  loadImage_closure.prototype = $desc;
  function Drawable(future, fetched) {
    this.future = future;
    this.fetched = fetched;
  }
  Drawable.builtin$cls = "Drawable";
  if (!"name" in Drawable)
    Drawable.name = "Drawable";
  $desc = $collectedClasses.Drawable;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Drawable.prototype = $desc;
  function Drawable_closure(this_0) {
    this.this_0 = this_0;
  }
  Drawable_closure.builtin$cls = "Drawable_closure";
  if (!"name" in Drawable_closure)
    Drawable_closure.name = "Drawable_closure";
  $desc = $collectedClasses.Drawable_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Drawable_closure.prototype = $desc;
  function init_closure0() {
  }
  ...
  function init_closure1() {
  }
  init_closure1.builtin$cls = "init_closure1";
  if (!"name" in init_closure1)
    init_closure1.name = "init_closure1";
  $desc = $collectedClasses.init_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ...
  $desc = $collectedClasses.LevelMenu;
  if ($desc instanceof Array)
    $desc = $desc[1];
  LevelMenu.prototype = $desc;
  function LevelMenu_reset_closure() {
  }
  LevelMenu_reset_closure.builtin$cls = "LevelMenu_reset_closure";
  if (!"name" in LevelMenu_reset_closure)
    LevelMenu_reset_closure.name = "LevelMenu_reset_closure";
  $desc = $collectedClasses.LevelMenu_reset_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  LevelMenu_reset_closure.prototype = $desc;
  function LevelMenu_reset_closure0(this_0) {
    this.this_0 = this_0;
  }
  LevelMenu_reset_closure0.builtin$cls = "LevelMenu_reset_closure0";
  if (!"name" in LevelMenu_reset_closure0)
    LevelMenu_reset_closure0.name = "LevelMenu_reset_closure0";
  $desc = $collectedClasses.LevelMenu_reset_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  LevelMenu_reset_closure0.prototype = $desc;
  function LevelMenu_draw_closure(ctx_0) {
    this.ctx_0 = ctx_0;
  }
  LevelMenu_draw_closure.builtin$cls = "LevelMenu_draw_closure";
  if (!"name" in LevelMenu_draw_closure)
    LevelMenu_draw_closure.name = "LevelMenu_draw_closure";
  $desc = $collectedClasses.LevelMenu_draw_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ...
  $desc = $collectedClasses.LevelTitle;
  if ($desc instanceof Array)
    $desc = $desc[1];
  LevelTitle.prototype = $desc;
  function LevelTitle_draw_closure(ctx_0) {
    this.ctx_0 = ctx_0;
  }
  LevelTitle_draw_closure.builtin$cls = "LevelTitle_draw_closure";
  if (!"name" in LevelTitle_draw_closure)
    LevelTitle_draw_closure.name = "LevelTitle_draw_closure";
  $desc = $collectedClasses.LevelTitle_draw_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
